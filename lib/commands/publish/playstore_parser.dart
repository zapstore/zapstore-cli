...
class PlayStoreParser {
  Future<PartialApp> run(
      {required PartialApp app, String? originalName, CliSpin? spinner}) async {
    final url =
    ...
    if (app.description.isEmpty) {
      ...
      app.description = markdownAppDescription;
    }
    ...
    for (final imageUrl in imageUrls) {
      if (imageUrl.trim().isNotEmpty) {
        ...
        final (imageHash, imageMimeType) = await renameToHash(imagePath);
    ...
    // TODO: Add images setter
    // app.images = {...app.images, ...imageBlossomUrls};
